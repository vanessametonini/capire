...
elseif ( $lang === 'ar' ) {
  ...
  $quem = get_field('btn_quem_somos_ar', $page->ID);
  $apoie = get_field('btn_apoie_ar', $page->ID);
  $telegram = "http://t.me/capiremov_en";
}
...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/style.css?3fsd454s4545s38">
